...
const BASE_URL = "http://192.168.1.91:9080"; // 🔁 Update this for production or Netlify
...
export const addNewSite = async (siteData) => {
  try {
    const response = await fetch("http://192.168.1.91:9080/siteMasterData", {
      method: "POST",
      headers: {
...
export const addCameraReport = async (report) => {
  const response = await fetch("http://192.168.1.91:9080/camera-reports", {
    method: "POST",
